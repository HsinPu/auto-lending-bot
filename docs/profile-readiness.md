...
- Dynamic duration: `DYNAMIC_DURATION_ENABLED`, `DURATION_LOW_DAYS`, `DURATION_MEDIUM_DAILY_RATE`, `DURATION_MEDIUM_DAYS`, `DURATION_HIGH_DAILY_RATE`, `DURATION_HIGH_DAYS`, `DURATION_EXTREME_DAILY_RATE`, `DURATION_EXTREME_DAYS`
