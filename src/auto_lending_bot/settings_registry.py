...
SETTING_DEFINITIONS: tuple[SettingDefinition, ...] = (
    ...
    SettingDefinition("AUTO_REBALANCE_OPEN_OFFERS", "Operations", "bool", "true"),
    SettingDefinition("AUTO_CANCEL_OPEN_OFFERS", "Operations", "bool", "true", danger_level="high"),
    SettingDefinition("STALE_OFFER_REPRICE_ENABLED", "Operations", "bool", "true", danger_level="high"),
    ...
    SettingDefinition("DYNAMIC_DURATION_ENABLED", "Strategy", "bool", "true"),
    SettingDefinition("DURATION_LOW_DAYS", "Strategy", "int", "2"),
    SettingDefinition("DURATION_MEDIUM_DAILY_RATE", "Strategy", "float", "0.0002191780821917808"),
    SettingDefinition("DURATION_MEDIUM_DAYS", "Strategy", "int", "7"),
    SettingDefinition("DURATION_HIGH_DAILY_RATE", "Strategy", "float", "0.000410958904109589"),
    SettingDefinition("DURATION_HIGH_DAYS", "Strategy", "int", "30"),
    SettingDefinition("DURATION_EXTREME_DAILY_RATE", "Strategy", "float", "0.0006849315068493151"),
    SettingDefinition("DURATION_EXTREME_DAYS", "Strategy", "int", "120"),
